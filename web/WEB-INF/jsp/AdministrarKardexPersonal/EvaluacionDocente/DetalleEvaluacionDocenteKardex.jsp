                                                ...
                                                <tr id="li${detalle.id_evaluacion_docente}">
                                                    ...
                                                    <td data-title="ACCIONES">
                                                        <div class="btn-group" role="group">
                                                            <form name="evaluacion${detalle.id_evaluacion_docente}" action="<c:url value="./FileDownload.fautapo"/>" method="GET">
                                                            ...
                                                            &nbsp;
                                                            <form name="forma"  action="<c:url value="/FormularioRegistroEvaluacionKardex.fautapo"/>" method="GET">
