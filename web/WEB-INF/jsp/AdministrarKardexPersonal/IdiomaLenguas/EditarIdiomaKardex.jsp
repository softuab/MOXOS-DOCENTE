        ...
        <c:if test="${!empty id_rol}">
            <main class="app-content3">
                ...
                <div class="row"> 
                    <div class="col-sm-12">
                        <div class="tile">
                            <form:form cssClass="form-horizontal" modelAttribute="model" method="POST" action="${pageContext.request.contextPath}/RegistrarModificarIdiomaLenguas.fautapo" enctype="multipart/form-data">
                                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                <form:hidden path="id_persona_kardex"/>
                                <form:hidden path="id_idioma"/>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <small class="form-text text-muted" id="url_idiomaHelp">Cargar imagen del dcumento original de titulo de idioma</small>
