    ...
    <body class="app sidebar-mini rtl">
                            ...
                            <div class="tile-body">
                                <ul class="list-unstyled" id="listactividadesacademicas">
                                    <c:forEach var="detalle" items="${detalles}"> 
                                        <li class="media" id="li${detalle.id_activades_academicas}">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p>
                                                    ...
                                                    <div class="toggle-flip">
                                                        <label>
                                                            Desea aprobar el documento? <input type="checkbox" name="chk${detalle.id_activades_academicas}" data-metodo="${detalle.id_activades_academicas}" onclick="actualizaraprobacion(this)" <c:out value="${detalle.aprobado ? 'checked': ''}"/>><span class="flip-indecator" data-toggle-on="SI" data-toggle-off="NO"></span>
                                                        </label>
                                                    </div> 
                                                </c:if>
                                                </p>
                                                <div class="text-right">
                                                    <div class="btn-group" role="group">
                                                        <form name="academcias${detalle.id_activades_academicas}" action="<c:url value="./FileDownload.fautapo"/>" method="GET">
                                                        ...
                                                        &nbsp;
                                                        <form name="forma"  action="<c:url value="/FormularioRegistroActividadesAcademicasKardex.fautapo"/>" method="GET">
                                                            <input type="hidden" name="id_activades_academicas" value='${detalle.id_activades_academicas}' />
                                                            <input type="hidden" name="id_persona" value='${id_persona}' />
                                                            <button class="btn btn-primary" type="submit"><i class="fas fa-user-edit"></i></button>
                                                        </form>
                                                        &nbsp; 
                                                        <button class="btn btn-primary" data-metodo="${detalle.id_activades_academicas}" data-name="li${detalle.id_activades_academicas}" onclick="deleteitem(this, 'li${detalle.id_activades_academicas}')" type="submit"><i class="far fa-trash-alt"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>   
        ...
        <script>
                                                            ...
                                                            function actualizaraprobacion(input) {
                                                                var data = {
                                                                    id_activades_academicas: $(input).data("metodo"),
                                                                    estado: $(input).prop('checked')
                                                                };
                                                                $.get('./ModificarEstadoAprobacionDocumentoActividadesAcademicas.fautapo', data, function (data)
                                                                {
                                                                    if (data.status !== "OK") {
                                                                        swal("Oops", data.message, "error");
                                                                    }
                                                                ...
                                                                swal({
                                                                    ...
                                                                    switch (value) {
                                                                        case "Eliminar":
                                                                            ...
                                                                            $.get('./EliminarActividadesAcademicas.fautapo', data, function (data)
                                                                            {
                                                                                if (data.status === "OK") {
