                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="text-right">
                                                    <div class="btn-group" role="group">
                                                        <form name="descarrgar${detalle.id_produccion_cientifica}" action="<c:url value="./FileDownload.fautapo"/>" method="GET">
                                                        ...
                                                        &nbsp;
                                                        <form name="forma"  action="<c:url value="/FormularioRegistroProduccionKardex.fautapo"/>" method="GET">
