    ...
    <body class="app sidebar-mini rtl">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p>
                                                    ...
                                                    <div class="toggle-flip">
                                                        <label>
                                                            Desea aprobar el documento? <input type="checkbox" name="chk${detalle.id_modalidadingreso}" data-modalidad="${detalle.id_modalidadingreso}" onclick="actualizaraprobacion(this)" <c:out value="${detalle.aprobado ? 'checked': ''}"/>><span class="flip-indecator" data-toggle-on="SI" data-toggle-off="NO"></span>
                                                        </label>
                                                    </div> 
                                                </c:if>
                                                </p>
                                                <div class="text-right">
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        ...
                                                        &nbsp;
                                                        <form name="forma"  action="<c:url value="/FormularioRegistroModalidadIngresoKardex.fautapo"/>" method="GET">
                                                            <input type="hidden" name="id_modalidadingreso" value='${detalle.id_modalidadingreso}' />
                                                            <input type="hidden" name="id_persona" value='${id_persona}' />
                                                            <button class="btn btn-primary" type="submit"><i class="fas fa-user-edit"></i></button>
                                                        </form>
                                                        &nbsp; 
                                                        <button class="btn btn-primary" data-modalidad="${detalle.id_modalidadingreso}" data-name="li${detalle.id_modalidadingreso}" onclick="deleteitem(this, 'li${detalle.id_modalidadingreso}')" type="submit"><i class="far fa-trash-alt"></i></button>
        ...
        <script>
                                                            ...
                                                            function actualizaraprobacion(input) {
                                                                var data = {
                                                                    id_modalidadingreso: $(input).data("modalidad"),
                                                                    estado: $(input).prop('checked')
                                                                };
                                                                $.get('./ModificarEstadoAprobacionDocumentoModalidadIngreso.fautapo', data, function (data)
                                                                {
                                                                    if (data.status !== "OK") {
                                                                        swal("Oops", data.message, "error");
                                                                    }
                                                                ...
                                                                swal({
                                                                    ...
                                                                    switch (value) {
                                                                        case "Eliminar":
                                                                            ...
                                                                            $.get('./EliminarModalidadIngreso.fautapo', data, function (data)
                                                                            {
                                                                                if (data.status === "OK") {
