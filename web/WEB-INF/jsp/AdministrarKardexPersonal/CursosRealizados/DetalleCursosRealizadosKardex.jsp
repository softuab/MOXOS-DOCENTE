                                ...
                                <ul class="list-unstyled" id="listcursos">
                                    <c:forEach var="detalle" items="${detalles}"> 
                                        <li class="media" id="li${detalle.id_cursos_realizados}">
                                            <img src="<c:url value="/imagenes/Document.png" />" cheight="50px" width="50px" class="align-self-center mr-3 rounded-circle" onclick="vistapreviadocumentos(this)" data-id="${detalle.id_cursos_realizados}" data-tabla="cursosrealizados" onMouseOver="this.style.cursor = 'pointer'">
                                            <div class="media-body">
                                                ...
                                                <div class="text-right">
                                                    <div class="btn-group" role="group">
                                                        <form name="descarrgar${detalle.id_cursos_realizados}" action="<c:url value="./FileDownload.fautapo"/>" method="GET">
                                                        ...
                                                        &nbsp;
                                                        <form name="forma"  action="<c:url value="/FormularioRegistroCursosRealizadosKardex.fautapo"/>" method="GET">
