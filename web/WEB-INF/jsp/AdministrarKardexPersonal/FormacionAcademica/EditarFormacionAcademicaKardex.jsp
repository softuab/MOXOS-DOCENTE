                ...
                <div class="row"> 
                    <div class="col-sm-12">
                        <div class="tile">
                            ...
                            <form:form cssClass="form-horizontal" modelAttribute="model" method="POST" action="${pageContext.request.contextPath}/RegistrarModificarFormacionAcademica.fautapo" enctype="multipart/form-data">
