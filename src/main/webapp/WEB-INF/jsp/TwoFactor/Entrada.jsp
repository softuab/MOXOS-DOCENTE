...
<section class="lockscreen-content">
    <div class="lock-box"><img class="rounded-circle user-image" src="${simagen}">
        ...
        <p class="text-center text-muted">Activar/Desactivar vertificacion de dos pasos docente</p>
        <form:form method="post" cssClass="unlock-form" modelAttribute="model"
                   action="${pageContext.request.contextPath}/twofactor/activarodesactivar">
