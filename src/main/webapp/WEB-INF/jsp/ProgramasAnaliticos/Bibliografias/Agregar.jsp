...
<div class="row">
    <div class="col">
        <div class="mb-3">
            ...
            <select data-id="${model.id_dct_programa_analitico}" onchange="cambiarTipoReferencia(this,document.getElementById('divtiporeferenciabibliografica'))" class="form-select">
    ...
    <div class="col" id="divtiporeferenciabibliografica">
        <c:if test="${group.tipo_referncia==1}">
            <form:form name="forma" onsubmit="return false;" method="post" modelAttribute="model"
                       action="${pageContext.request.contextPath}/programaanaanalitico/bibliografias/agregardocumento">
        ...
        <c:if test="${group.tipo_referncia==2}">
            <form:form name="forma" onsubmit="return false;" method="post" modelAttribute="model"
                ...
                <div class="mb-3">
                    ...
                    <input name="fecha_publicacion" id="fecha_publicacion" type="date" value="<fmt:formatDate value="${model.fecha_publicacion}" pattern="yyyy-MM-dd" />" class="form-control date" >
                    <form:errors path="fecha_publicacion" cssClass="invalid"></form:errors>
        ...
        <c:if test="${group.tipo_referncia==3}">
            <form:form name="forma" onsubmit="return false;" method="post" modelAttribute="model"
                ...
                <div class="mb-3">
                    ...
                    <input name="fecha_consulta" id="fecha_consulta" type="date" value="<fmt:formatDate value="${model.fecha_consulta}" pattern="yyyy-MM-dd" />" class="form-control date" >
                    <form:errors path="fecha_consulta" cssClass="invalid"></form:errors>
