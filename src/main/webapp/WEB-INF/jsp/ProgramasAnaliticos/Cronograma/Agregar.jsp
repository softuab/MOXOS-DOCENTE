...
<form:form   method="post" onsubmit="return false;" modelAttribute="model"
             action="${pageContext.request.contextPath}/programaanaanalitico/cronograma/agregar">
    ...
    <div class="mb-3">
        ...
        <input type="date" class="form-control date" id="text_fecha" name="text_fecha" value="<fmt:formatDate value="${model.fecha}" pattern="yyyy-MM-dd" />">
