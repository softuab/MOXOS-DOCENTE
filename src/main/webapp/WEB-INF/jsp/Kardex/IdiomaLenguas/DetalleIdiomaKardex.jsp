                ...
                <div class="tile">
                    ...
                    <div class="tile-title-w-btn">
                        <input class="form-control mr-sm-2" type="search" id="buscardetalleidioma"
                               placeholder="Buscar titulo" onkeyup="filterlist('buscardetalleidioma', 'listidioma')">
                        <form name="forma" class="unlock-form" action="<c:url value="/FormularioRegistroIdiomaKardex"/>"
                              method="GET">
                            <input type="hidden" name="id_persona" value='${id_persona}'/>
                            ...
                            <c:forEach var="detalle" items="${idiomas}">
                                <li class="media" id="li${detalle.id_idioma}">
                                    <img src="<c:url value="/static/image/Document.png" />" height="50px" width="50px"
                                         ...
                                         data-id="${detalle.id_idioma}" data-tabla="idioma"
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="toggle-flip">
                                            <label>
                                                Desea aprobar el documento? <input type="checkbox"
                                                                                   name="chk${detalle.id_idioma}"
                                                                                   data-idioma="${detalle.id_idioma}"
                                        ...
                                        <div class="text-end">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                &nbsp;
                                                <form name="forma"
                                                      action="<c:url value="/FormularioRegistroIdiomaKardex"/>"
                                                      method="GET">
                                                ...
                                                &nbsp;
                                                <button class="btn btn-primary" data-idioma="${detalle.id_idioma}"
                                                        data-name="li${detalle.id_idioma}"
                                                        onclick="deleteitem(this, 'li${detalle.id_idioma}')"
                                                        data-url="<c:url value="/EliminarIdiomaLenguas"/>"
...
<script>
    ...
    function deleteitem(input) {
        let data = {
            id_idioma: input.dataset.idioma,
