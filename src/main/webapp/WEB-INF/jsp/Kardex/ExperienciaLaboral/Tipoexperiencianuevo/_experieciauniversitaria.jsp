...
<form:form cssClass="form-horizontal" modelAttribute="model" method="POST" action="${pageContext.request.contextPath}/${accion}" enctype="multipart/form-data">
    ...
    <div class="mb-3 row">
        <label class="control-label col-md-3">Universidad<span  class="text-danger font-weight-bold">*</span></label> 
        <div class="col-md-9">
        <form:input cssClass="form-control" path="institucion" readonly="true" aria-describedby="institucionHelp"></form:input>
