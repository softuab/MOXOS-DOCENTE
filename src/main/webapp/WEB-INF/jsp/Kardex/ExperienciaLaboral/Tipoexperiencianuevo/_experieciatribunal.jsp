...
<br>
<p>
    <strong>Nota: </strong>  Tribunal de internado rotatorio, defensas de trabajos científicos, examen de mesa, examen de grado, asesor o tutor y/o otros
</p>
    ...
    <form:errors path="tipo_experiencia_laboral" cssClass="invalid"></form:errors>  
        <div class="mb-3 row">
            ...
            <form:errors path="institucion" cssClass="invalid"></form:errors>
                <small class="form-text text-muted" id="institucionHelp">Universidad o Institucion donde trabajo.</small>
            </div>
        </div>      
        <div class="mb-3 row">
            <label class="control-label col-md-3">Cartera o Funcion<span  class="text-danger font-weight-bold">*</span></label>
            <div class="col-md-9">
        ...
        <div class="mb-3 row">
            <label class="control-label col-md-3">Descripcion de la cartera o Funcion<span  class="text-danger font-weight-bold">*</span></label>
            <div class="col-md-9">
            ...
            <form:errors path="detalle" cssClass="invalid"></form:errors>
                <small class="form-text text-muted" id="detalleelp">Descripcion de la cartera o funcion que realizaba.</small>
            </div>
        </div> 
        <div class="mb-3 row">
