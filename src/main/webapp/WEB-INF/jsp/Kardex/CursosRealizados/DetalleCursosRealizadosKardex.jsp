                ...
                <div class="tile">
                    ...
                    <div class="tile-title-w-btn">
                        <input class="form-control mr-sm-2" type="search" id="buscardetallecursos"
                               placeholder="Buscar titulo" onkeyup="filterlist('buscardetallecursos', 'listcursos')">
                        <form name="forma" class="unlock-form"
                              action="<c:url value="/FormularioRegistroCursosRealizadosKardex"/>" method="GET">
                            <input type="hidden" name="id_persona" value='${id_persona}'/>
                        ...
                        <ul class="list-unstyled" id="listcursos">
                            <c:forEach var="detalle" items="${detalles}">
                                <li class="media" id="li${detalle.id_cursos_realizados}">
                                    <img src="<c:url value="/static/image/Document.png" />" cheight="50px" width="50px"
                                         ...
                                         data-id="${detalle.id_cursos_realizados}" data-tabla="cursosrealizados"
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>
                                            ...
                                            <b>Fecha Emision:</b>&nbsp;<fmt:formatDate pattern="dd/MM/yyyy"
                                                                                       value="${detalle.fechapresentacion}"/><br>
                                        ...
                                        <div class="toggle-flip">
                                            <label>
                                                Desea aprobar el documento? <input type="checkbox"
                                                                                   name="chk${detalle.id_cursos_realizados}"
                                                                                   data-metodo="${detalle.id_cursos_realizados}"
                                        ...
                                        <div class="text-end">
                                            <div class="btn-group" role="group">
                                                <form name="descarrgar${detalle.id_cursos_realizados}"
                                                ...
                                                <form name="forma"
                                                      ...
                                                      method="GET">
                                                    <input type="hidden" name="id_cursos_realizados"
                                                           value='${detalle.id_cursos_realizados}'/>
                                                    <input type="hidden" name="id_persona" value='${id_persona}'/>
                                                    <button class="btn btn-primary" type="submit"><i
                                                ...
                                                <button class="btn btn-primary"
                                                        data-metodo="${detalle.id_cursos_realizados}"
                                                        data-name="li${detalle.id_cursos_realizados}"
                                                        data-url="<c:url value="/EliminarCursosRealizados"/>"
                                                        onclick="deleteitem(this, 'li${detalle.id_cursos_realizados}')"
