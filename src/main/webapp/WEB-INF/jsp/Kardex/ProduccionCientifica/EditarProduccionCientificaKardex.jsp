        ...
        <c:if test="${!empty id_rol}">
            <main class="app-content3">
                ...
                <div class="row"> 
                    <div class="col-sm-12">
                        <div class="tile">
                            <form:form cssClass="form-horizontal" modelAttribute="model" method="POST" action="${pageContext.request.contextPath}/RegistrarModificarProduccion" enctype="multipart/form-data">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-9">
                                        <form:select cssClass="form-select"  path="categoria" items="${detallecategoria}" itemLabel="value" itemValue="id"/>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-9">
                                        <form:select cssClass="form-select"  path="tipo_produccion" items="${detalleproduccion}" itemLabel="value" itemValue="id"/>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-9">
                                        <form:select cssClass="form-select"  path="tipo_de_recurso" items="${detalleobjetivo}" itemLabel="value" itemValue="id"/>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-9">
                                        <form:input cssClass="form-control date" type="date" path="text_fecha_certificacion" aria-describedby="fecha_certificacionHelp"></form:input>
                                ...
                                <div class="tile-footer">
                                    <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Registrar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="${pageContext.request.contextPath}/ListarProduccionCientifica?id_persona_kardex=${model.id_persona_kardex}&id_persona=${model.id_persona}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                                </div>
                            </form:form>
                        </div>
                    </div>
