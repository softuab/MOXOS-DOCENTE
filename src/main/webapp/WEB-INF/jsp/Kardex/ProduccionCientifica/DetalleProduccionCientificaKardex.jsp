    ...
    <body class="app sidebar-mini rtl">
                    ...
                    <div class="col-sm-12">
                        <div class="tile"> 
                            ...
                            <div class="tile-title-w-btn">
                                ...
                                <form name="forma" class="unlock-form" action="<c:url value="/FormularioRegistroProduccionKardex"/>" method="GET">     
                                    <input type="hidden" name="id_persona" value='${id_persona}' /> 
                                    ...
                                    <c:forEach var="detalle" items="${detalles}"> 
                                        <li class="media" id="li${detalle.id_produccion_cientifica}">
                                            <img src="<c:url value="/static/image/Document.png" />"  height="50px" width="50px"class="align-self-center mr-3 rounded-circle" onclick="vistapreviadocumentos(this)"
                                                 data-url="<c:url value="/VistapreviaimagenDocumentos" />"  data-id="${detalle.id_produccion_cientifica}" data-tabla="produccioncientifica" onMouseOver="this.style.cursor = 'pointer'">
                                            <div class="media-body">
                                                ...
                                                <div class="text-end">
                                                    <div class="btn-group" role="group">
                                                        <form name="descarrgar${detalle.id_produccion_cientifica}" action="<c:url value="./FileDownload"/>" method="GET">
                                                        ...
                                                        &nbsp;
                                                        <form name="forma"  action="<c:url value="/FormularioRegistroProduccionKardex"/>" method="GET">
                                                        ...
                                                        &nbsp; 
                                                        <button class="btn btn-primary" data-metodo="${detalle.id_produccion_cientifica}" data-name="li${detalle.id_produccion_cientifica}" data-url="<c:url value="/EliminarProduccionCientifica"/>" onclick="deleteitem(this, 'li${detalle.id_produccion_cientifica}')" type="submit"><i class="fa fa-trash"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>   
        ...
        <script>
            ...
            function deleteitem(input) {
                let data = {
                    id_produccion_cientifica: input.dataset.metodo,
