    ...
    <main class="app-content3">
        <div class="app-title">
            <div>
                ...
                <p>Por designacion, Concurso de merito y Examen de Competencia</p>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                <div class="tile">
                    <form:form cssClass="form-horizontal" modelAttribute="model" method="POST"
                               action="${pageContext.request.contextPath}/RegistrarModificarModalidadIngresos"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <form:select cssClass="form-select select" path="id_programa" items="${programas}"
                                             itemLabel="value" itemValue="id" aria-describedby="id_programaHelp"/>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <form:select cssClass="form-select" path="modalidadingreso" items="${modalidadingreso}"
                                             itemLabel="value" itemValue="id" aria-describedby="modalidadingresoHelp"/>
                                <form:errors path="modalidadingreso" cssClass="invalid"></form:errors>
                                <small class="form-text text-muted" id="modalidadingresoHelp">Seleccionar la modalidad
                                    de ingreso.</small>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="control-label col-md-3">Fecha ingreso<span
                                    class="text-danger font-weight-bold">*</span></label>
                            <div class="col-md-9">
                                <form:input type="date" cssClass="form-control date"
                                            path="text_fechaingreso"></form:input>
                                <form:errors path="text_fechaingreso" cssClass="invalid"></form:errors>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="control-label col-md-3">Documento original del documento<span
                                    class="text-danger font-weight-bold">*</span></label>
                            <div class="col-md-9">
                                <input class="form-control-file" name="Image" id="Image" type="file"
                                       aria-describedby="url_modalidadingresoHelp"
                                       accept="image/x-png,image/gif,image/jpeg,application/pdf">
                                <form:errors path="url_modalidadingreso" cssClass="invalid"></form:errors>
                                <small class="form-text text-muted" id="url_modalidadingresoHelp">Cargar imagen del
                                    documento original del memorandum o resolucion rectoral</small>
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="tile-footer">
                            <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Registrar
                                                          ...
                                                          href="${pageContext.request.contextPath}/ListaModalidadIngreso?id_persona_kardex=${model.id_persona_kardex}&id_persona=${model.id_persona}"><i
