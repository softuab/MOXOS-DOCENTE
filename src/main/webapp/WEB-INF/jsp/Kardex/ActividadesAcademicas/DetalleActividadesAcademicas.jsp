...
<c:if test="${!empty id_rol}">
    <main class="app-content3">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="tile">
                    <form name="forma" class="unlock-form" action="<c:url value="/IndexKardexPersonal"/>"
                          method="GET">
                            ...
                            <c:forEach var="detalle" items="${detalles}">
                                <li class="media" id="li${detalle.id_activades_academicas}">
                                    <img src="<c:url value="/static/image/Document.png" />" height="50px" width="50px"
                                         ...
                                         data-id="${detalle.id_activades_academicas}" data-tabla="actividadesacademicas"
                                         onMouseOver="this.style.cursor = 'pointer'">
                                    <div class="media-body">
                                        <h5 class="mt-0 mb-1">${detalle.tipo_de_actividad}</h5>
                                        <p>
                                            <b>Descripcion actividad:</b>&nbsp;${detalle.descripcion_actividad}<br>
                                            <b>Tipo de documento</b>&nbsp;${detalle.tipo_documento}&nbsp;
                                            NRO. ${detalle.detalle_documento}<br>
                                        ...
                                        <div class="toggle-flip">
                                            <label>
                                                Desea aprobar el documento? <input type="checkbox"
                                                                                   name="chk${detalle.id_activades_academicas}"
                                                                                   data-metodo="${detalle.id_activades_academicas}"
                                        ...
                                        <div class="text-end">
                                            <div class="btn-group" role="group">
                                                <form name="academcias${detalle.id_activades_academicas}"
                                                      action="<c:url value="./FileDownload"/>" method="GET">
                                                    <input type="hidden" name="name"
                                                           value='${detalle.url_actividades_academicas}'/>
                                                    <input type="hidden" name="directorio"
                                                           value='actividadesacademicas'/>
                                                ...
                                                <form name="forma"
                                                      action="<c:url value="/FormularioRegistroActividadesAcademicasKardex"/>"
                                                      method="GET">
                                                    <input type="hidden" name="id_activades_academicas"
                                                           value='${detalle.id_activades_academicas}'/>
                                                    <input type="hidden" name="id_persona" value='${id_persona}'/>
                                                    <button class="btn btn-primary" type="submit"><i
                                                ...
                                                <button class="btn btn-primary"
                                                        data-metodo="${detalle.id_activades_academicas}"
                                                        data-name="li${detalle.id_activades_academicas}"
                                                        onclick="deleteitem(this, 'li${detalle.id_activades_academicas}')"
                                                        data-url="<c:url value="/EliminarActividadesAcademicas"/>"
...
<script>
    ...
    function deleteitem(input) {
        let data = {
            id_activades_academicas: input.dataset.metodo,
