    ...
    <body class="app sidebar-mini rtl">
                    ...
                    <div class="col-sm-12">
                        <div class="tile"> 
                            ...
                            <div class="tile-title-w-btn">
                                ...
                                <form name="forma" class="unlock-form" action="<c:url value="/FormularioRegistroFormacionKardex"/>" method="GET">     
                                    <input type="hidden" name="id_persona" value='${id_persona}' /> 
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="text-end">
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        ...
                                                        &nbsp;
                                                        <form name="forma"  action="<c:url value="/FormularioRegistroFormacionKardex"/>" method="GET">
                                                        ...
                                                        &nbsp; 
                                                        <button class="btn btn-primary" data-formacion="${detalle.id_formacion}" data-name="li${detalle.id_formacion}" onclick="deleteitem(this, 'li${detalle.id_formacion}')" data-url="<c:url value="/EliminarFormacionAcademica"/>" type="submit"><i class="fa fa-trash"></i></button>
        ...
        <script>
            ...
            function deleteitem(input) {
                let data = {
                    id_formacion: input.dataset.formacion,
