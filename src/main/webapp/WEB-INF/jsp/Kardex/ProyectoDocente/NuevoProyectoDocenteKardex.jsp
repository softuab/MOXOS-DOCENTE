            ...
            <div class="col-sm-12">
                <div class="tile">
                    <form:form cssClass="form-horizontal" modelAttribute="model" method="POST"
                               action="${pageContext.request.contextPath}/RegistrarPersonaProyectoKardex"
                        ...
                        <div class="mb-3 row">
                            <label class="control-label col-md-3">Tipo del proyecto<span
                                    class="text-danger font-weight-bold">*</span></label>
                            <div class="col-md-9">
                                <form:select cssClass="form-select" path="tipodeproyecto"
                                             items="${detalletipoproyecto}" itemLabel="value" itemValue="id"/>
