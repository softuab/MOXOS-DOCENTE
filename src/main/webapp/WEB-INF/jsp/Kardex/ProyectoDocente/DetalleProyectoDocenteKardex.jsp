                            ...
                            <c:forEach var="detalle" items="${detalles}">
                                <li class="media" id="li${detalle.id_personas_proyecto}">
                                    <img src="<c:url value="/static/image/Document.png" />" height="50px" width="50px"
                                         ...
                                         data-id="${detalle.id_personas_proyecto}" data-tabla="proyectodocente"
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>
                                            ...
                                            <b>Es un representante
                                                sindical?</b>&nbsp;${detalle.representaciondirigencial ? 'SI' : 'NO'}<br>
                                            <c:if test="${id_rol==8}">
                                        ...
                                        <div class="toggle-flip">
                                            <label>
                                                Desea aprobar el documento? <input type="checkbox"
                                                                                   name="chk${detalle.id_personas_proyecto}"
                                                                                   data-proyectodocente="${detalle.id_personas_proyecto}"
                                        ...
                                        <div class="text-end">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                &nbsp;
                                                <form name="forma"
                                                      action="<c:url value="/FormularioRegistroProyectoKardex"/>"
                                                      method="GET">
                                                    <input type="hidden" name="id_personas_proyecto"
                                                           value='${detalle.id_personas_proyecto}'/>
                                                    <input type="hidden" name="id_persona" value='${id_persona}'/>
                                                    <button class="btn btn-primary" type="submit"><i
                                                ...
                                                <button class="btn btn-primary"
                                                        data-proyectodocente="${detalle.id_personas_proyecto}"
                                                        data-name="li${detalle.id_personas_proyecto}"
                                                        data-url="<c:url value="/EliminarProyectoDocente"/>"
                                                        onclick="deleteitem(this, 'li${detalle.id_personas_proyecto}')"
...
<script>
    ...
    function deleteitem(input) {
        let data = {
            id_personas_proyecto: input.dataset.proyectodocente,
