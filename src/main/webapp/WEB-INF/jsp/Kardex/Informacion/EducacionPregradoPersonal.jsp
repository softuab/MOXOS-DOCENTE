...
<head>
    ...
    <body class="app sidebar-mini rtl">
        <main class="app-content3">
            <div class="app-title">
                <div>
                    <h1><i class="fa fa-address-card"></i>&nbsp; Informacion academica pregrado actual</h1>
                </div>
            </div>
            <div class="row"> 
                <div class="col-sm-12">
                    <div class="tile">
                        <form:form cssClass="form-horizontal" modelAttribute="model" method="POST" action="${pageContext.request.contextPath}/kardex/RegistrarEducacionPregradoPersonal" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-9">
                                    <form:input type="date" path="text_fechatituloprofesion" cssClass="form-control  date" placeholder="Seleccionar fecha" aria-describedby="fechatituloprofesionHelp"></form:input>
