                ...
                <div class="row">
                    <div class="col">
                        <div class="container">
                                        ...
                                        <div class="card border-secondary mb-3">
                                            ...
                                            <div class="card-footer text-center">
                                                <div>
                                                    ...
                                                    <a class="btn btn-primary" href="javascript:enviarsolicitud(document.idformfase);"><< Volver</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <c:if test="${parametros.id_fase >= 1000}">
                                <div class="row">
                                    <div class="col-sm-6 mx-auto">
                                        <div class="card border-secondary mb-3">
                                            <div class="card-header"><i class="fa fa-exclamation-triangle"></i>&nbsp;&nbsp;ATENCION
                                ...
                                <div class="row">
                                    <div class="col-sm-6 mx-auto">
                                        <div class="card border-secondary mb-3">
                                            ...
                                            <div class="card-body text-secondary">
                                                <form method="post" name="idformfase"
                                                      action="<c:url value="/libretas/registrarAvanzarFase"/>">
                                                    &iquest;Esta seguro que desea avanzar de :&nbsp;<b><c:out
                                                        value="${fase_actual}"/></b><br> a la fase de :&nbsp;<b><c:out
                                                        value="${fase_siguiente}"/></b>?<br/>
                                                    <input type="hidden" name="avanzar" value="Avanzar >>">
                                                    <input type="hidden" name="${_csrf.parameterName}"  value="${_csrf.token}"/>
                                                    <input type="hidden" name="id_asignacion" value="<c:out value="${parametros.id_asignacion}"/>">
                                                    ...
                                                    <input type="hidden" name="id_tipo_grado"  value="<c:out value="${parametros.id_tipo_grado}"/>">
                                            ...
                                            <div class="card-footer text-center">
                                                <div>
                                                    <a class="btn btn-primary"
                                                       href="javascript:enviarsolicitud(document.formretorno);"><< Volver</a>
                                                    <a class="btn btn-primary"
                                                       href='javascript:enviarsolicitud(document.idformfase);'>Avanzar >></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
