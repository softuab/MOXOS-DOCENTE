...
<main class="app-content3">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-address-card"></i>&nbsp; Detalle de planilla</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="tile table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <td><a  href="${pageContext.request.contextPath}/rrhh/Descargar?id=${item.ID}" class="btn btn-primary btn-sm" >Descargar</a>
                        </c:forEach>
                    </tbody>
                </table>
            </div>
