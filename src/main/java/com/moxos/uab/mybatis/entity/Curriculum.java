...
public class Curriculum extends Personas {
    ...
    public int getId_sub_rubro() {
        return id_sub_rubro;
    }

    public void setId_sub_rubro(int id_sub_rubro) {
        this.id_sub_rubro = id_sub_rubro;
    }
    ...
    public String getSub_rubro() {
        return sub_rubro;
    }

    public void setSub_rubro(String sub_rubro) {
  ...
  */
    ...
    public int getId_dct_adjunto() {
        return id_dct_adjunto;
    }

    public void setId_dct_adjunto(int id_dct_adjunto) {
        this.id_dct_adjunto = id_dct_adjunto;
    }
