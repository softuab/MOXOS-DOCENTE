...
public class ImprimirLibretaForma2 {
    ...
    public ImprimirLibretaForma2(LibretasDocente libreta, List<Libretas> parametros, int notaminima, HttpServletResponse response, String path) {
    ...
    public ImprimirLibretaForma2(HttpServletResponse response) {
        this.response = response;
    }
    ...
    public void CreateLibretaRegular() throws IOException {
        ...
        try {
            try {
                ...
                HeaderFooterPageEvent event = new HeaderFooterPageEvent(libreta, path);
